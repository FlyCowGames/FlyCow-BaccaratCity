...
*Auto-generated from knowledge.json — do NOT edit directly.*

## Patterns (What Works)

### Landmark-specific light signatures elevate hero buildings above generic effects
- **Weight:** 0.9 | **Domain:** rendering | **Applied:** 7x (✓7)
- Each major landmark benefits from a unique animated light effect that matches its architectural identity — Eiffel Tower sparkle (S181), Sai Van cable harp (S183), Grand Lisboa lotus crown (S184), Macau Tower LED crown (S186), Morpheus exoskeleton LED (S187), Venetian campanile golden cascade (S188), Galaxy diamond LED canopy (S191). These are more memorable than generic casino effects (neon glow, sky beams) and give each landmark its own visual fingerprint at night. The IIFE + canvas billboard + setInterval + window._init* pattern is now well-proven across 7 implementations.
- *Evidence:* S181 Eiffel sparkle, S183 Sai Van harp, S184 Lisboa crown, S186 Macau Tower LED, S187 Morpheus exoskeleton, S188 Venetian campanile, S191 Galaxy diamond all deployed without JS errors. Pattern is stable and efficient across Peninsula, Cotai, and bridge landmarks.
- Tags: rendering, landmarks, night-effects, canvas, pattern

### CSS particle effects are lightweight alternatives to WebGL
- **Weight:** 0.8 | **Domain:** rendering | **Applied:** 13x (✓13)
...
- **Weight:** 0.8 | **Domain:** animation | **Applied:** 10x (✓10)
...
- **Weight:** 0.8 | **Domain:** audio | **Applied:** 5x (✓5)
...
- **Weight:** 0.7 | **Domain:** interactivity | **Applied:** 20x (✓20)
...
- **Weight:** 0.7 | **Domain:** landmarks | **Applied:** 4x (✓4)
...
- **Weight:** 0.7 | **Domain:** animation | **Applied:** 4x (✓4)
...
- **Weight:** 0.65 | **Domain:** atmosphere | **Applied:** 5x (✓5)
...
- **Weight:** 0.6 | **Domain:** rendering | **Applied:** 1x (✓1)
...
- **Weight:** 0.6 | **Domain:** rendering | **Applied:** 4x (✓3)
...
- **Weight:** 0.6 | **Domain:** interactivity | **Applied:** 1x (✓1)
...
- **Weight:** 0.6 | **Domain:** landmarks | **Applied:** 2x (✓2)
...
- **Weight:** 0.6 | **Domain:** interactivity | **Applied:** 2x (✓2)
...
- **Weight:** 0.6 | **Domain:** landmarks | **Applied:** 5x (✓5)
...
- **Weight:** 0.6 | **Domain:** landmarks | **Applied:** 1x (✓1)
...
- Tags: heritage, cultural-authenticity, portuguese, canvas, billboard, incremental
...
- Tags: css, animation, ux, loading, first-impression

### Separate tick handlers for independent orbit systems
- **Weight:** 0.5 | **Domain:** interactivity | **Applied:** 1x (✓1)
...
- **Weight:** 0.5 | **Domain:** landmarks | **Applied:** 1x (✓1)
...
- **Weight:** 0.5 | **Domain:** audio | **Applied:** 1x (✓1)
...
- **Weight:** 0.5 | **Domain:** animation | **Applied:** 1x (✓1)
...
- **Weight:** 0.5 | **Domain:** atmosphere | **Applied:** 1x (✓1)
...
- Tags: css, atmosphere, weather, animation, cinematic, camera-effect
...
- Tags: css, atmosphere, night, cinematic, bokeh, performance
...
- Tags: api, weather, ui, progressive-disclosure
...
- Tags: css, animation, atmosphere, weather, temperature
...
- Tags: css, atmosphere, rendering, night-effects
...
- Tags: css, atmosphere, weather, ui, animation
...
- Tags: atmosphere, weather, css, complementary-effects
...
- Tags: atmosphere, color, night, css, visual-depth
...
- Tags: atmosphere, css, time-of-day, weather, color

### Canvas tower silhouette with distributed sparkle points creates convincing light show
- **Weight:** 0.5 | **Domain:** rendering | **Applied:** 1x (✓1)
...
- Tags: canvas, rendering, animation, landmarks, night-effects
...
- Tags: canvas, rendering, animation, bridges, night-effects

## Anti-Patterns (What to Avoid)

### ⚠️ CesiumJS bloom post-processing with Google 3D Tiles
- **Severity:** high
...
### ⚠️ CallbackProperty for billboard image causes black rectangles
- **Severity:** high
...
### ⚠️ Parallax on mobile breaks layout
- **Severity:** medium
...
### ⚠️ Accumulating absolute-positioned bottom UI elements cause mobile overlap
- **Severity:** high
...
- Tags: mobile, css, layout, overlap, audit
