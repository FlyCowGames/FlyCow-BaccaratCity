...
### [rendering] CSS particle effects are lightweight alternatives to WebGL
**Weight:** 0.8 | **Applied:** 4x | **Successful:** 4x
...
### [animation] Staggered animation delays prevent mechanical feel
**Weight:** 0.8 | **Applied:** 10x | **Successful:** 10x
...
### [audio] Web Audio API for procedural sound without external files
**Weight:** 0.8 | **Applied:** 5x | **Successful:** 5x
...
### [animation] Time-of-day gated features fill temporal gaps and add realism
**Weight:** 0.7 | **Applied:** 3x | **Successful:** 3x
...
### [interactivity] Enhancing existing features is high-impact with low risk
**Weight:** 0.6 | **Applied:** 2x | **Successful:** 2x
...
### [rendering] Staggered CSS transitions create cinematic reveal effects
**Weight:** 0.6 | **Applied:** 1x | **Successful:** 1x
...
### [rendering] Canvas text with shadowBlur creates convincing neon glow
**Weight:** 0.6 | **Applied:** 2x | **Successful:** 2x
...
### [interactivity] Separate tick handlers for independent orbit systems
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [interactivity] Progress indicators improve guided experience UX
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
**Tags:** ux, ui, tour
...
### [landmarks] Canvas steam/smoke wisps add life to static billboards
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [landmarks] Cultural balance through complementary heritage elements
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [audio] Position-aware audio zones using proximity falloff with altitude gate
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [landmarks] Official symbols and emblems add cultural depth
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [animation] Heritage district ground-level transport adds cultural authenticity
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [atmosphere] Distributed small light points create coastline-tracing glow effects
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [atmosphere] CSS cloud overlays are effective weather-reactive sky atmosphere
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [animation] Larger canvas entities with detail reward night scenes
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
### [atmosphere] Canvas forked lightning with recursive branching creates realistic bolts
**Weight:** 0.5 | **Applied:** 1x | **Successful:** 1x
...
CesiumJS bloom applies to the entire scene, causing severe oversaturation/washout with Google 3D Tiles. Tried contrast values 119 down to 40 — all caused unacceptable results.
...
A record of significant choices made during development and the rationale behind them.
