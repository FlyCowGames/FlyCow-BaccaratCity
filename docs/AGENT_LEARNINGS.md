...
- **Weight:** 0.6 | Applied: 2 | Successful: 2
...
- **Domain:** rendering
- **Weight:** 0.6 | Applied: 1 | Successful: 1
...
- **Evidence:** Session 91: 5 tai chi groups visible 5-9 AM only with 30-min fade ramps. Zero JS errors, first morning-specific feature. Fills gap where all time-gated features were night-only.
